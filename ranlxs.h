...
*     Append the next n single-precision random random numbers
*     at the end of the vector r
*
*   void ranlxs_fill_ising_vector(std::vector<double>& r);
*     Fill a vector with random +/-1 integers
*
*
* Version: 2.2
...
void ranlxs_push_back(std::vector<double>& r, int n);
double ranlxs_rand();
void ranlxs_fill_ising_vector(std::vector<int>& r);
